...
class GraphicsInterface:
    ...
    def __init__(self):
        self.win = GraphWin("The poker of dices", 600, 400)
        self.win.setBackground("orange")
        banner = Text(Point(300,30), "Game On!")
        banner.setSize(24)
        banner.setFill("purple")
        banner.setStyle("bold")
        banner.draw(self.win)
        self.msg = Text(Point(300,380), "Welcome to Dice Adventure")
        self.msg.setSize(18)
